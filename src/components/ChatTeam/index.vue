    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                <div contenteditable="true" ref="content-chat" class="form-control content-group content-box-chat" @input="setTextMessage" @keyup="keyUpTextMessageContent" @keydown.enter="enterTagMemberMessageContent"></div>
